...
The 95% Confidence Interval is 50 $\pm$ 30.8039.
...
```
The 87% Confidence Interval for the percentage drop is 0.08 $\pm$ 0.042. I conclude that there was indeed a drop.
...
```
Compare the p-value (1) to the given level of significance (a = 0.01). Since the p-value is much less than the level of significance, we reject the alternative hypothesis. I conclude that the reduction in dissolved oxygen is large enough to impact the fish.
